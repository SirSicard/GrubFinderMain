  ...
  <body class="flex flex-col leading-relaxed tracking-wide gradient font-poppins">
    ...
    <section class="py-8 bg-white border-b">
      <div class="container flex flex-wrap pt-4 pb-12 mx-auto">
        ...
        <div class="flex flex-col flex-grow flex-shrink w-full p-6 md:w-3/3">
          <div class="flex-1 overflow-hidden bg-white rounded-t rounded-b-none shadow">
            <a href="#" class="flex flex-wrap no-underline hover:no-underline">
              ...
              <p class="px-6 mb-5 text-base text-gray-600">
                ...
                at ipsum eu nunc commodo posuere et sit amet ligula.</p>
            </a>
          </div>
          <div class="flex-none p-6 mt-auto overflow-hidden bg-white rounded-t-none rounded-b shadow">
            <div class="flex items-center justify-start">
              <button class="px-8 py-4 mx-auto font-extrabold text-gray-800 rounded shadow-lg lg:mx-0 hover:underline gradient2">Action</button>
            </div>
          </div>
        </div>
        ...
        <div class="flex flex-col flex-grow flex-shrink w-full p-6 md:w-1/3">
          ...
          >
            <div class="flex items-center justify-end">
              <button
                class="px-8 py-4 mx-auto font-extrabold text-gray-800 rounded shadow-lg lg:mx-0 hover:underline gradient2"
              >
                Back to restaurant
              </button>
            </div>
